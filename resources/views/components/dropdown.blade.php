...
@php
    switch ($align) {
        case 'left':
            $alignmentClasses = 'ltr:origin-top-left ltr:left-0 rtl:right-0 rtl:origin-top-right';
            break;
        case 'top':
        ...
        case 'right':
        default:
            $alignmentClasses = 'ltr:origin-top-right ltr:right-0 rtl:origin-top-left rtl:left-0';
            break;
    }
